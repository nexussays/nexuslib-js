...
class WindowUtils
{
   ...
   static getSize()
   {
      ...
      return ({
         ...
         "contentHeight": doc.offsetHeight || doc.scrollHeight || body.offsetHeight || body.scrollHeight,//((Browser.isIE || Browser.quirksMode) ? doc.scrollHeight : doc.offsetHeight),
         "contentWidth": doc.offsetWidth || doc.scrollWidth || body.offsetWidth || body.scrollWidth,//((Browser.isIE || Browser.quirksMode) ? doc.scrollWidth : doc.offsetWidth),
